...
from utils.inference_utils import compute_similarity, stableMatching, get_bbox_masks_from_gdino_sam, \
    get_object_proposal, getColor, create_instances, nms, apply_nms, get_features, get_features_CLIP
...
output_dir = './other_FFA'
json_filename = 'object_features_clip_L14.json'
if use_adapter:
