...
# cocoDt = cocoGt.loadRes("datasets/ycbv/test/weight_adapted_PE_coco_instances_results_prediction_all.json")

# test RoboTools
cocoGt = COCO("datasets/RoboTools/test/scene_gt_coco_all_v2.json")
cocoDt = cocoGt.loadRes("datasets/RoboTools/test/weight_adapter_PE_adapted2_cls_coco_instances_results_prediction_all.json")
